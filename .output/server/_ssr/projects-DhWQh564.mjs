//#region node_modules/.nitro/vite/services/ssr/assets/projects-DhWQh564.js
...
var projects = [
	{
		...
		tag: "SCADA + PLC",
		summary: "Full automation of a concrete batching plant with recipe control, weighing accuracy, and production reporting.",
		cover: batching_plant_default,
		problem: "The plant was running on manual switchgear with inconsistent batch quality, no traceability, and frequent rework. Operators had no live visibility into aggregate/water/cement dosing, and reports were maintained by hand — making audits and dispatch reconciliation slow and error-prone.",
		solution: [
	...
	},
	{
		...
		tag: "SQL + HMI",
		summary: "Plant-wide dashboard aggregating live machine data, KPIs, and energy usage across multiple lines.",
		cover: hmi_scada_default,
		problem: "Data was trapped inside individual PLCs and HMIs on the shop floor. Management had no consolidated view of OEE, energy consumption, or downtime causes across lines — making improvement decisions reactive and slow.",
		solution: [
		...
		outcomes: [
			...
			{
				label: "OEE visibility",
				value: "Real-time"
			},
			{
				label: "Downtime response",
				value: "-60%"
			},
			{
	...
	},
	{
		...
		tag: "LabVIEW + DAQ",
		summary: "LabVIEW-driven test rig for pressure, leak and endurance testing of industrial valves with automatic reporting.",
		cover: panel_default,
		problem: "The OEM was running valve qualification tests manually with analog gauges and paper records. Test consistency depended on the operator, and generating per-valve test certificates for customers was a full day of clerical work.",
		solution: [
	...
	},
	{
		...
		tag: "SCADA + SQL",
		summary: "Line-level production tracking with shift targets, live counts, and rejection analysis.",
		cover: hmi_scada_default,
		problem: "Shift production was reported at end-of-shift with no way to intervene mid-shift. Rejection reasons were not tracked systematically, and target-vs-actual was calculated in spreadsheets a day later.",
		solution: [
	...
	},
	{
		...
		tag: "PLC + SQL",
		summary: "High-frequency PLC data logging into SQL with query APIs for downstream analytics.",
		cover: panel_default,
		problem: "Process engineers needed high-resolution historical data for troubleshooting, but existing HMIs only kept a few days of trends locally. Getting a specific timestamp's process values meant coordinating a plant visit.",
		solution: [
	...
	},
	{
		...
		tag: "IoT + SCADA",
		summary: "Section-wise energy consumption monitoring with cost allocation and anomaly alerts.",
		cover: hero_automation_default,
		problem: "Total electricity bill was rising without a clear picture of which sections or machines were driving the increase. There was no way to correlate energy use with production output.",
		solution: [
	...
	},
	{
		...
		tag: "PLC + HMI",
		summary: "Centralised recipe storage and version-controlled deployment to machines on the floor.",
		cover: batching_plant_default,
		problem: "Every machine on the line had its own local recipe list. Changes were made on the HMI without traceability, causing inconsistent product across machines and disputes about who changed what.",
		solution: [
	...
	},
	{
		...
		tag: "IoT + Analytics",
		summary: "Continuous machine condition monitoring with predictive alerts for maintenance planning.",
		cover: hero_automation_default,
		problem: "Critical machines were maintained on a fixed calendar schedule regardless of actual condition. Unexpected breakdowns still caused hours of downtime, and planned maintenance was often unnecessary work.",
		solution: [
