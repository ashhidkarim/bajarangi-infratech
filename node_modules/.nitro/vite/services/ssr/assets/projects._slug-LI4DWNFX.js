import { n as projects } from "./projects-DhWQh564.js";
import { t as Route } from "./projects._slug-D1lF_5F8.js";
		...
		children: [
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-background/70 via-background/70 to-background" }),
						/* @__PURE__ */ jsx("div", { className: "absolute inset-0 grid-lines opacity-60" })
					]
				}), /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsx("div", {
					...
					children: project.outcomes.map((o) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsx(SectionKicker, { children: "The Problem" }),
						/* @__PURE__ */ jsx("h2", {
						...
						/* @__PURE__ */ jsx(SectionKicker, { children: "Our Solution" }),
						/* @__PURE__ */ jsx("h2", {
							className: "mt-3 font-display font-bold text-2xl md:text-3xl",
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx(SectionKicker, { children: "Tech Stack" }),
						/* @__PURE__ */ jsx("h2", {
							className: "mt-3 font-display font-bold text-2xl md:text-3xl",
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "mx-auto max-w-7xl px-5 lg:px-8",
					children: [
						/* @__PURE__ */ jsx(SectionKicker, { children: "Gallery" }),
						/* @__PURE__ */ jsx("h2", {
							className: "mt-3 font-display font-bold text-2xl md:text-3xl",
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: project.gallery.map((img, i) => /* @__PURE__ */ jsx("figure", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx(SectionKickerCenter, { children: "Similar Project?" }),
						/* @__PURE__ */ jsxs("h2", {
							className: "mt-3 font-display font-bold text-3xl md:text-5xl",
							children: ["Let's engineer ", /* @__PURE__ */ jsx("span", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs(Link, {
								...
								children: ["Get Free Consultation ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
							}), /* @__PURE__ */ jsxs("a", {
								href: WA,
								target: "_blank",
								rel: "noreferrer",
								...
								children: [/* @__PURE__ */ jsx(MessageCircle, { className: "h-4 w-4 text-brand" }), " WhatsApp Now"]
							})]
						})
					]
				})
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "mx-auto max-w-7xl px-5 lg:px-8",
					children: [
						/* @__PURE__ */ jsx(SectionKicker, { children: "More Case Studies" }),
						/* @__PURE__ */ jsx("h2", {
							className: "mt-3 font-display font-bold text-2xl md:text-3xl",
...
function SectionKicker({ children }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("span", { className: "h-px w-6 bg-brand" }), children]
	});
}
function SectionKickerCenter({ children }) {
	return /* @__PURE__ */ jsxs("div", {
		className: "inline-flex items-center gap-2 text-xs uppercase tracking-[0.25em] text-brand",
		children: [
			/* @__PURE__ */ jsx("span", { className: "h-px w-6 bg-brand" }),
			children,
			/* @__PURE__ */ jsx("span", { className: "h-px w-6 bg-brand" })
		]
	});
